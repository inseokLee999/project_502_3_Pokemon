...
public class JoinValidator implements Validator<JoinRequest>, RequiredValidator, EmailValidator {

    private final MemberMapper mapper;

    @Override
    public void check(JoinRequest form) {
        ...
        checkTrue(mapper.exists(email) == 0L, new AlertException("이미 가입된 회원입니다",status));
